...
while i < len(browsers):
    ...
    try:
        ...
        installed.open("http://127.0.0.1:5000/")
        break
    except:
        i += 1
        continue
...
if i == len(browsers):
    print(f"\n\nPython didn't find your browser. You can access the website manually by entering the following URL in wour web browser: http://127.0.0.1:5000/\n\n")
